...
Task({
  ...
  prompt:
    'クライアントエラーがどこで処理されているか、medium thoroughnessで探索してください',
})
...
Task({
  ...
  prompt:
    'RESTful APIの設計パターンを調査し、このプロジェクトに適したアプローチを提案してください',
})
...
- ✅ **MCP優先**: mcp\_\_で始まるWeb fetchツールがあれば優先
